...
BOT_TOKEN = getenv("BOT_TOKEN","7657159740:AAHjfaLL2CTyJKqsJqXQl55Fk5NY9EuhR3c")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "4544397609"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("pablo music bot")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6062173301").split())
...
SUPPORT_CHANNEL = getenv(
    "https://t.me/+U0Sqf0VshyE5Y2I1", None
